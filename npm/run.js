...
const PACKAGE_NAME = "codex-mcp-rs";
const REPO_OWNER = "missdeer";
const REPO_NAME = "codex-mcp-rs";
...
async function downloadAndExtract(cacheDir) {
  ...
  try {
    ...
    console.error(
      "  1. Download from https://github.com/missdeer/codex-mcp-rs/releases"
    );
    console.error(`  2. Place binary at: ${binaryPath}`);
    console.error("");
    console.error("Or install via cargo:");
    console.error("  cargo install codex-mcp-rs");
    process.exit(1);
  } finally {
